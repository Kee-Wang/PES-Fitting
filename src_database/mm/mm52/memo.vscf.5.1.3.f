...
C**2 GB
     ...
     1FORM='UNFORMATTED',status='UNKNOWN')
      OPEN(165,FILE=''//tpdn//'/rotation165',
     1FORM='UNFORMATTED',status='UNKNOWN')
      OPEN(166,FILE=''//tpdn//'/rotation166',
     1FORM='UNFORMATTED',status='UNKNOWN')
      OPEN(167,FILE=''//tpdn//'/rotation167',
     1FORM='UNFORMATTED',status='UNKNOWN')
      OPEN(168,FILE=''//tpdn//'/rotation168',
     1FORM='UNFORMATTED',status='UNKNOWN')
      OPEN(169,FILE=''//tpdn//'/rotation169',
     1FORM='UNFORMATTED',status='UNKNOWN')
      OPEN(170,FILE=''//tpdn//'/rotation170',
     1FORM='UNFORMATTED',status='UNKNOWN')
