...
implicit none
  ...
  natm=6         ! change to the number of atoms
  ncoeff=5835       ! change to the number of coeff. (size of c in bemsa.f90)
  data_size=51158    ! change to the number of data points in pts.dat
  a0=2.5
  dwt=1000000
  ...
  open(12,file="51158.fitting",status='old')
