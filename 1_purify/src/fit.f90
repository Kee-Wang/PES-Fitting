...
implicit none
  ...
  ncoeff=524       ! change to the number of coeff. (size of c in bemsa.f90)
  data_size=6244    ! change to the number of data points in pts.dat
  a0=2.5
  dwt=1000000
  ...
  open(12,file="gt_6.fitting",status='old')
