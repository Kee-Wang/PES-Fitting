...
implicit none
  ...
  real::coeff(1:2304) ! change to number of coefficients
...
contains
  ...
  function g(xyz)
    ...
    real,dimension(1:2304)::p   ! change to number of popynomials
                               ! (size of p in bemsa.f90)
    real,dimension(1:72)::m  ! change to number of monomials
