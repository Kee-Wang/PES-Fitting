...
call pes2_init (fname, pes_x2y2z1_nk, pes_x2y2z1_pot)

!===================================================================
! px_pcv(2:natm) = (/ &
!  cx_t(-1, 3, 0, 1.0e+06*pes_bohr,2.0_wp*pes_bohr), & ! px_pcv(2)
!  ...
!  cx_t(-1, 3, 0, 1.0e+06*pes_bohr,2.0_wp*pes_bohr), & ! px_pcv(N-1)
!  cx_t( M, 3, 0, 1.0e+30*pes_bohr,2.0_wp*pes_bohr) /) ! px_pcv(N)
!===================================================================
px_pcv(2:5) = (/ &
  cx_t(-1, 3, 0, 1.0e+06*pes_bohr,2.0_wp*pes_bohr), &
  cx_t(-1, 3, 0, 1.0e+06*pes_bohr,2.0_wp*pes_bohr), &
  cx_t(-1, 3, 0, 1.0e+06*pes_bohr,2.0_wp*pes_bohr), &
  cx_t( 5, 3, 0, 1.0e+30*pes_bohr,2.0_wp*pes_bohr) /)
...
call pes2_reinit (pes_x2y2z1_pot)
