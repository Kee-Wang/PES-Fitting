...
implicit none
  ...
  real::coeff(1:524) ! change to number of coefficients
...
contains
  ...
  function g(xyz)
    ...
    real,dimension(1:524)::p   ! change to number of popynomials
                               ! (size of p in bemsa.f90)
    real,dimension(1:500)::m  ! change to number of monomials
